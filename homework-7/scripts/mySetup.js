function preload() {
  ...
  sprite_sheet = loadSpriteSheet('./assets/animations/child/childspritesheet.png', 206, 250, 41); 
  explode_animation = loadAnimation(sprite_sheet); 

  // load the full sprite sheet for example reference only
  sprite_sheet_image = loadImage('./assets/animations/child/childspritesheet.png'); 
